...
Some desctiption about the project.


## Models

The Data Enricher is a software tool that models data probabilistically, and generates synthetic data based on the model. It contains two main types of probabilistic models:
...
*The detailed mathematical description about the KDE models can be found in (Bölat, 2023).*
...
*The detailed description about the testing procedure can be found in (Bölat, 2023).*
